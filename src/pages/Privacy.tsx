...
const Privacy = () => {
  return (
    <Layout>
      <div className="max-w-4xl mx-auto px-6 py-16 bg-gray-950 text-white">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <ul className="list-disc pl-8 my-4 text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">4. How We Share Your Information</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">7. Changes to This Privacy Policy</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">8. Contact Us</h2>
          <p className="text-gray-300">
