...
const formSchema = z.object({
  ...
  openToJobOpportunities: z.boolean().optional(),
...
const Register = () => {
  ...
  // Helper function to add/remove interests
  ...
  // Helper function to add/remove skills
  const toggleSkill = (skill: string) => {
    ...
    form.setValue("skills", selectedSkills.join(", "));
  };
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              {step === 2 && (
                <>
                  ...
                  <FormSection title="Networking Preferences">
                    <FormField
                      control={form.control}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            This determines how we prioritize matches for you
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            A brief introduction about yourself (maximum 200 characters)
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
              ...
              {step === 3 && (
                <>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            This helps us match you with relevant professionals
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>
                              Optional, leave blank if you prefer not to share
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
                  ...
                  <FormSection title="Networking Goals">
                    <FormField
                      control={form.control}
                      name="networkingGoals"
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Primary Networking Goal</FormLabel>
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            <FormControl>
                              <SelectTrigger>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                          ...
                          <div className="space-y-1 leading-none">
                            <FormLabel>Open to Mentoring Others</FormLabel>
                            <FormDescription>
                              I'm willing to share my knowledge and expertise with others
                            </FormDescription>
                          </div>
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                          ...
                          <div className="space-y-1 leading-none">
                            <FormLabel>Open to Job Opportunities</FormLabel>
                            <FormDescription>
                              I'm interested in hearing about new job opportunities
                            </FormDescription>
                          </div>
                        </FormItem>
                      )}
                ...
                <>
                  <FormSection title="Skills & Expertise">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Core Skills & Expertise</FormLabel>
                          <FormControl>
                            <Input placeholder="e.g. JavaScript, Marketing, Leadership" {...field} />
                          </FormControl>
                          <FormDescription>
                            Your main professional skills, separated by commas
                          </FormDescription>
                          <FormMessage />
                          
                          <div className="mt-3">
                            <p className="text-sm mb-2">Popular skills</p>
                            <div className="flex flex-wrap gap-2">
                              {['JavaScript', 'Marketing', 'Leadership', 'Design', 'Project Management', 'Data Analysis', 'Finance', 'Communication'].map((skill) => (
                                <Badge 
                                  key={skill}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="e.g. Public Speaking, Excel, Research" {...field} />
                          </FormControl>
                          <FormDescription>
                            Additional skills that are part of your expertise
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Personal interests help with meaningful connections
                          </FormDescription>
                          <FormMessage />
                          ...
                          <div className="mt-3">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {['Photography', 'Travel', 'Fitness', 'Cooking', 'Reading', 'Music', 'Sports', 'Technology'].map((interest) => (
                                <Badge 
                                  key={interest}
                  ...
                  <FormSection title="Communication & Availability">
                    <FormGroup>
                      <FormField
                        control={form.control}
                        name="availability"
                        ...
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value || "public"}>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="networked">Networked (Only matched users)</SelectItem>
                              <SelectItem value="private">Private (Only by invitation)</SelectItem>
                            </SelectContent>
                          </Select>
                          <FormDescription>
