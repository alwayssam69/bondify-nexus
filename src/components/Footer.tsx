        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-muted-foreground mb-6 max-w-xs">
              Find your perfect match with our intelligent matching system that connects compatible people.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-muted-foreground hover:text-primary transition-colors">
